SELECT t.ano AS ano, t.periodo AS periodo, t.co_turma AS co_turma, t.descricao AS descricao_turnma, a.co_aluno AS co_aluno, a.nome AS nome_aluno, d.no_disciplina AS nome_disciplina, ROUND(snatd.somatorio/t.num_provas,2) AS media_final
